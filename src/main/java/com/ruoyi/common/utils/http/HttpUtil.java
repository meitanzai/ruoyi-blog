...
public class HttpUtil {
     ...
     * 发送GET请求
     *
     * @param host    发送主机  例如： http:192.168.0.24
     * @param path    发送路径  例如： /getData
     ...
     * @throws Exception
     */
    public static HttpResponse doPost(String host, String path, Map<String, String> headers, Map<String, String> querys, File file) throws Exception {
        HttpClient httpClient = wrapClient(host);
        ...
        if (file != null) {
            ...
            FileEntity entity = new FileEntity(file, suffix);

...
public class LoginService
{
    ...
    public User login(String username, String password)
    {
        ...
        */
        ...
        AsyncManager.me().execute(AsyncFactory.recordLogininfor(username,user.getEmail(), Constants.LOGIN_SUCCESS, MessageUtils.message("user.login.success")));
    ...
    {
        // 验证码校验
        if (ToolUtils.isNotEmpty(ServletUtils.getRequest().getAttribute(ShiroConstants.CURRENT_CAPTCHA)))
        {
            AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, Constants.LOGIN_FAIL, MessageUtils.message("user.jcaptcha.error")));
            throw new CaptchaException();
        }

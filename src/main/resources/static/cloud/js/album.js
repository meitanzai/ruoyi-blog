$(function () {
    ...
    $("#layui-icon-close03").click(function () {
        ...
        $.ajax({
            type: "post",
            url: "/cloud/file/setShare",    //请求发送到dataActiont处
...
window.onload = function () {
    ...
    document.getElementById("downloadall").onclick = function () {
        ...
        window.location.href = "/cloud/file/downloadFileList?ids="+ids;
        layer.msg("下载准备中...");
    };
...
function shareimage(path,name,newname,id) {
    ...
    document.getElementById("linkid").innerText = localhostPaht+"/cloud/file/downloadFile?fileId="+id;
...
// 详细信息弹窗(图片页面独有)
function detailsdataimg(newname,name,size,filePath,urlPath,ctime,stime,dcount) {
    console.log(newname);
    console.log(name);
    console.log(size);
    ...
    console.log(stime);
    console.log(dcount);
    document.getElementById("avatar1").src = localhostPaht+"/"+urlPath;
    ...
    document.getElementById("filepath1").innerText = filePath;
